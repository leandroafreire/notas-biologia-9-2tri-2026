...
def carregar_dados():
    ...
    df = pd.read_excel("Cálculo de Notas - 9º - 2ºTri.xlsx", sheet_name=0, header=2)
...
# TEXTO ALTERADO: Removido (2º Trimestre) e adicionada a instrução do zero inicial
st.write("Digite seu RA para visualizar sua nota. **Atenção: digite o RA sem o zero no início do número.**")
...
if st.button("Ver Nota"):
    if ra_aluno:
        ...
        if not aluno_encontrado.empty:
            ...
            # MENSAGEM DE ERRO ALTERADA para reforçar a regra do zero
